...
const evTags = h => (h.gs ? '<span class="ev gs">GRAND SLAM</span>' : "") + (h.wo ? '<span class="ev wo">WALK-OFF</span>' : "");
...
<style>
  ...
  *{box-sizing:border-box} body{margin:0;background:var(--night);color:var(--chalk);font-family:"IBM Plex Sans",system-ui,sans-serif;line-height:1.5}
  ...
  .ev{display:inline-block;font-family:"Barlow Condensed",sans-serif;font-weight:800;font-size:11px;letter-spacing:1px;color:var(--chalk);border-radius:4px;padding:1px 6px;margin-left:6px;vertical-align:middle} .ev.gs{background:#3c8a4a} .ev.wo{background:#e5533d}
...
// ---------- homepage prerender block ----------
{
  ...
  const block = `
<h2>Longest home runs — ${longDate(latest)}</h2>
...
<p>No Doubters tracks every Major League Baseball home run with its Statcast distance, exit velocity, and launch angle, and links each one to the official MLB highlight. The board above updates live during games; these pages update every morning.</p>
